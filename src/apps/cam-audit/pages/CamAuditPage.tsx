...
const CamAuditPage = () => {
  ...
  const [activeTab, setActiveTab] = useState("lease-document");
        ...
        <div className="tab-sec">
          ...
          >
            <TabsList className="h-7.5">
              <TabsTrigger value="lease-document" className="h-7.5">
                Lease Document
              </TabsTrigger>
              <TabsTrigger value="cam-statement" className="h-7.5">
                Cam Statement
              </TabsTrigger>
              <TabsTrigger value="invoice" className="h-7.5">
                Invoice
              </TabsTrigger>
              <TabsTrigger value="general-ledger" className="h-7.5">
                General Ledger
              </TabsTrigger>
              <TabsTrigger value="occupancy-report" className="h-7.5">
                Occupancy report
              </TabsTrigger>
            </TabsList>
          </Tabs>
